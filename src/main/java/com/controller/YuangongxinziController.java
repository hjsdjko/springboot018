...
public class YuangongxinziController {
    ...
    public R page(@RequestParam Map<String, Object> params,YuangongxinziEntity yuangongxinzi,
		...
		if(tableName.equals("yuangong")) {
			yuangongxinzi.setYuangonggonghao((String)request.getSession().getAttribute("username"));
		}
        EntityWrapper<YuangongxinziEntity> ew = new EntityWrapper<YuangongxinziEntity>();
    ...
    public R info(@PathVariable("id") Long id){
        YuangongxinziEntity yuangongxinzi = yuangongxinziService.selectById(id);
    ...
    public R save(@RequestBody YuangongxinziEntity yuangongxinzi, HttpServletRequest request){
        ...
        yuangongxinziService.insert(yuangongxinzi);
        return R.ok();
    }
    ...
    public R update(@RequestBody YuangongxinziEntity yuangongxinzi, HttpServletRequest request){
        //ValidatorUtils.validateEntity(yuangongxinzi);
        yuangongxinziService.updateById(yuangongxinzi);//全部更新
        return R.ok();
    }
    ...
    public R delete(@RequestBody Long[] ids){
        yuangongxinziService.deleteBatchIds(Arrays.asList(ids));
        return R.ok();
    }
    ...
    public R count(@RequestParam Map<String, Object> params,YuangongxinziEntity yuangongxinzi, HttpServletRequest request){
        ...
        EntityWrapper<YuangongxinziEntity> ew = new EntityWrapper<YuangongxinziEntity>();
        int count = yuangongxinziService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, yuangongxinzi), params), params));
